                ...
                {NavbarLinks.map((link) => {
                    return (
                        <Link
                            href={link.url}
                            key={link.label}
                            className=' text-[18px] w-[120px] p-2 rounded-md text-white font-medium hover:bg-[#e8e9e95d] hover:border-primary-border drop-shadow-xl flex justify-center items-center'
                        >
                            {link.label}
                        </Link>
                    )
