  ...
  return (
    <div className=" w-[1200px]  flex justify-between  items-center">
      <div className=" flex justify-center items-center gap-2">
        <Image src={union} alt="union-logo" width={36} height={36} />
        <div className="flex justify-center items-center gap-2">
          <Image src={meta} alt="union-logo" width={55.25} height={18.58} />
        ...
        <div className="flex overflow-hidden">
          <div className="relative">
            <Input
              type="text"
              placeholder="Search"
              className="pl-10 border-[#242535] rounded-xl bg-[#242535] drop-shadow-2xl text-white focus:border-[#242535] ring-offset-[#242535]"
            />
            <Image
              src={search}
              alt="search-icon"
